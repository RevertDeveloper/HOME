...
export const fallbackApps: AppItem[] = [
  ...
  },
  {
    ...
    description:
      'Un chat inteligente que responde preguntas sobre **legislación española** de **forma precisa y trazable**.\n\nEste sistema ejecuta un modelo de inteligencia artificial en nuestros **servidores locales** —**sin depender de servicios externos**— y tiene acceso a toda la legislación consolidada del **Boletín Oficial del Estado (BOE)**.\n\nCuando realizas una consulta, el sistema busca automáticamente en una **base de datos vectorial** los artículos más relevantes, los analiza y genera una respuesta fundamentada exclusivamente en la **legislación vigente**. Además, proporciona **enlaces directos** a la página oficial del BOE para que puedas verificar y profundizar en cada fuente citada.\n\nEste sistema es **totalmente personalizable**: puede adaptarse a cualquier sector regulado (normativa fiscal, laboral, medioambiental, sanitaria…) y a cualquier empresa que necesite consultar legislación de forma rápida y fiable.',
  ...
  },
  {
    ...
    description:
      'Una herramienta que convierte **audio en texto** y lo transforma automáticamente en **informes útiles**.\n\nSeleccionas un modo según el tipo de audio —reuniones, lluvia de ideas, tareas, desarrollo de software o sesiones de terapia— y el sistema transcribe la grabación con **alta precisión**.\n\nDespués, un modelo de IA procesa el texto según el modo elegido: genera **actas de reuniones**, **listas de tareas priorizadas**, **resúmenes de ideas** o **informes clínicos estructurados**. El verdadero poder está en no perder nunca la información valiosa de una conversación: cada palabra queda registrada, organizada y lista para compartir con personas ausentes o para futuras consultas.\n\nEste sistema es **adaptable a cualquier empresa**: desde equipos que necesitan documentar sus reuniones, hasta clínicas que requieren historiales de sesiones o departamentos creativos que quieren capturar cada idea.',
  ...
  },
  {
    ...
    description:
      'Una interfaz de chat potente impulsada por modelos de inteligencia artificial que se ejecutan íntegramente en los **servidores de tu empresa**.\n\nA diferencia de otros servicios como ChatGPT o Gemini, toda la información se **procesa en local**: ningún dato sale de tus instalaciones, lo que garantiza la **privacidad total** y la **soberanía de tus datos**. Es la forma segura de impulsar la productividad de tus empleados con IA, sin el riesgo de filtrar información confidencial sobre clientes, proyectos o estrategias de negocio. **TODO SE QUEDA EN CASA**.\n\nEstos modelos se pueden equipar con herramientas personalizadas: acceso a **bases de datos internas**, generación de documentos, análisis de datos, **automatización de tareas** y mucho más.\n\nEs ideal para cualquier empresa que quiera usar inteligencia artificial avanzada con **total control** sobre su información.',
